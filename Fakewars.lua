			...
			repeat task.wait(3)
				for _,v in pairs( game.Players:GetPlayers()) do
					if v.Character.Humanoid.Health == 0 then
						...
						if pick == 1 then
							chat("L"..v.Name.." Looks like you forgot to get scripts bruh.")
						elseif pick == 2 then
							chat(v.Name.." do you eat losses for breakfast?")
						elseif pick == 3 then
							chat("Moon is made by SupaDogEat, "..v.Name.." L.")
						end
					end
				end
...
AddTag("IamNotHamza_GG","Owner", Color3.fromRGB(255, 0, 0))
AddTag("Tjgiacomino1r101","Dev", Color3.fromRGB(77, 255, 0))
AddTag("TjgiacominoALT","AC Mod", Color3.fromRGB(77, 255, 0))
AddTag("heckerSNITCH_new","Lead AC Mod", Color3.fromRGB(77, 255, 0))
AddTag("Tjgiacomino1r10","Script Co", Color3.fromRGB(77, 255, 0))
AddTag("heckerSNITCH5","Admin", Color3.fromRGB(77, 255, 0))
AddTag("ILikeEverything_16","Script Dev", Color3.fromRGB(77, 255, 0))

...
local Tab7 = window:NewTab("Bed-Nuker")
local Tab7Section = Tab7:NewSection("Bed-Nuker")
---Buttons
...
if lplr.Character.Humanoid.RigType == Enum.HumanoidRigType.R15 then
      ...
      decal.Texture = "http://www.roblox.com/asset/?id=12465242043"
      decal.Face = "Back"
...
Tab4Section:NewToggle("AntiCheat Detector","?",function(state)
if state then
_G.Ac = true
while _G.Ac == true do
wait(5)
